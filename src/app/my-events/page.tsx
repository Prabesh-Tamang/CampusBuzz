          ...
          {registrations.length === 0 ? (
            <div className="text-center py-20">
              ...
              <button
                ...
                className="px-6 py-3 bg-teal-600 hover:bg-teal-500 text-white rounded-xl font-semibold transition-colors"
              >
                Browse Events
              </button>
            </div>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        {!reg.confirmed && !reg.checkedIn && !reg.paymentId && (
                    ...
                    <div className="flex-shrink-0">
                      {reg.qrCode ? (
                        ...
                        <span className="px-4 py-2 text-xs text-amber-400 bg-amber-500/10 border border-amber-500/20 rounded-xl block text-center">
